...
def triangle(shader, vertices):
    return Figure(GL_TRIANGLES, shader, utils.prepare_vertices(vertices))

def rectangle(shader, vertices):
    return Figure(GL_TRIANGLES, shader, vertices=utils.prepare_vertices(vertices), indices=utils.prepare_indices([0,1,2,0,2,3]))
